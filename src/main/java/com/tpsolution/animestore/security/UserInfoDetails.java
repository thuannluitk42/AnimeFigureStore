...
import com.tpsolution.animestore.enums.UserRole;
...
public class UserInfoDetails implements OAuth2User, UserDetails {
    ...
    public static UserInfoDetails create(Users user, Map<String, Object> attributes) {
        List<GrantedAuthority> authorities = Collections.singletonList(new SimpleGrantedAuthority(UserRole.ROLE_CLIENT.name()));
